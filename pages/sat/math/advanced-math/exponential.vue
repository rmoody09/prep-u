<template>
    <h1 class="sat-guide-page-header">Exponential Functions</h1>
        ...
        <div class="sat-guide-section-content">
            ...
            <p>
                <math>
                    ...
                    <mo>=</mo>
                    <mi>a</mi><mo>·</mo><msup><mi>b</mi><mrow><mi>c</mi><mi>x</mi></mrow></msup>
                </math>
            </p>
            <p>
                Theoretically, there could be an additional constant added to the function, so the 
            </p>
            <p>
                <math>
                    <mi>f</mi><mo>(</mo><mi>x</mi><mo>)</mo>
                    <mo>=</mo>
                    <mi>a</mi><mo>·</mo><msup><mi>b</mi><mrow><mi>c</mi><mi>x</mi></mrow></msup><mo>+</mo><mi>d</mi>
                </math>
            </p>
