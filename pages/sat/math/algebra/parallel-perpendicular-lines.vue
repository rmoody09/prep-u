<template>
    ...
    <div class="section-description">
        ...
        <ol>
            <li>Find the slope of the original line.</li>
            <li>Find the negative reciprocal of the slope.</li>
            <li>Use the point-slope form of the equation of a line to find the equation of the perpendicular line.</li>
        </ol>
    </div>
</template>