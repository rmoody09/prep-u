<template>
    <h1 class="sat-guide-page-header">Rates, Proportions, and Unit Conversions</h1>
    ...
    <div class="sat-guide-section">
        ...
        <div class="sat-guide-section-content">
            ...
            <div class="sat-guide-subsection">
                <h3 class="sat-guide-subsection-header">Speed</h3>
                <div class="sat-guide-subsection-content">
                    ...
                    <p>
                        <math>
                            <mi>speed</mi><mo>=</mo><mfrac><mi>distance</mi><mi>time</mi></mfrac>
                        </math>
                    </p>
                    <p>
                    ...
                    <p>
                        <math>
                            <mi>distance</mi><mo>=</mo><mi>speed</mi><mo>×</mo><mi>time</mi>
                        </math>
                    </p>
                    <p>
                        <math>
                            <mi>time</mi><mo>=</mo><mfrac><mi>distance</mi><mi>speed</mi></mfrac>
                        </math>
                    </p>
                </div>
            </div>
            <div class="sat-guide-subsection">
                <h3 class="sat-guide-subsection-header">Price</h3>
                <div class="sat-guide-subsection-content">
                    <p>
                    ...
                    <p>
                        <math>
                            <mi>price</mi><mo>=</mo><mfrac><mi>cost</mi><mi>quantity</mi></mfrac>
                        </math>
                    </p>
                    <p>
                        For example, if you paid a total of $10 for 5 apples, then the price of each apple is <math><mfrac><mn>$10</mn><mi>5 apples</mi></mfrac> <mo>=</mo> <mi>$2 per apple</mi></math>.
                    </p>
                    <p>
                    ...
                    <p>
                        <math>
                            <mi>cost</mi><mo>=</mo><mi>price</mi><mo>×</mo><mi>quantity</mi>
                        </math>
                    </p>
                    <p>
                        For example, if tuna costs $15 per pound, and you bought 3 pounds, then you spent <math><mfrac><mn>$15</mn><mi>pound</mi></mfrac> <mo>×</mo> <mi>3 pounds</mi> <mo>=</mo> <mi>$45</mi></math>.
                    </p>
                    <p>
                    ...
                    <p>
                        <math>
                            <mi>quantity</mi><mo>=</mo><mfrac><mi>cost</mi><mi>price</mi></mfrac>
                        </math>
                    </p>
                    <p>
...
<style scoped>
/* Add styles for the math layout */
math {
    font-size: 1.1em;
}

/* Style for ordered list numbers to make them bold */
ol li::marker {
    font-weight: bold;
}
</style>
