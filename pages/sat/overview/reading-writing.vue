<template>
    ...
    <div class="section-description">
        ...
        <ul class="list-disc list-outside pl-4 pt-6 space-y-2">
            <li>
                <div class="font-bold">Craft and Structure</div>
            ...
            <li>
                <div class="font-bold">Information and Ideas</div>
                <ul class="list-[revert] list-outside pl-4">
                    <li>
            ...
            <li>
                <div class="font-bold">Standard English Conventions</div>
                <ul class="list-[revert] list-outside pl-4">
                    <li>
            ...
            <li>
                <div class="font-bold">Expression of Ideas</div>
                <ul class="list-[revert] list-outside pl-4">
                    <li>
    ...
    <div class="section-description">
        ...
        <ul class="list-disc list-outside pl-8 pt-6 space-y-2">
            <li>
                <div class="font-bold">Craft and Structure</div>
                <ul class="list-[revert] list-outside pl-4">
                    <li>
    ...
    <div class="sat-guide-bottom-nav">
        <div class="sat-guide-bottom-nav-item">
            <UButton to='/sat/overview/math' variant='outline' size='xl'>
                Next: Math Overview
                <template #trailing>
