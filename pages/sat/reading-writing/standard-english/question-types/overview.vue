<template>
    ...
    <h2 class="sat-guide-section-header">How to Identify the Type</h2>
    ...
    <h2 class="sat-guide-section-header">The Types</h2>
    <div class="section-description">
        ...
        <ul class="pt-6 pl-8">
            <li>
                ...
                <ul>
                    <li>The answer choices are mostly the same, but they each use a different pronoun.</li>
                    <li>
            ...
            <li>
                ...
                <ul>
                    <li>These answer choices will differ in terms of where they do or don't place apostrophes.</li>
                    <li>
            ...
            <li>
                ...
                <ul>
                    <li>In these you will notice longer answer choices, where the order of the words is very different from one choice to another, and many have different subjects (the noun performing the main verb).</li>
                    <li>
    ...
    <h2 class="sat-guide-section-header">Different Pronouns</h2>
    <div class="section-description">
        ...
        <div class="pt-6">
            <ClientOnly>
                <SATProblem problem_id="4d440ee6-5b94-4ef2-9813-bd9091183849" />
            </ClientOnly>
        </div>
    </div>

    <h2 class="sat-guide-section-header">Apostrophe Placement</h2>
    <div class="section-description">
        ...
        <div class="pt-6">
            <ClientOnly>
                <SATProblem problem_id="24bfba40-464a-4512-8962-cafea1d014ff" />
            </ClientOnly>
        </div>
    </div>
    ...
    <div class="section-description">
        ...
        <div class="pt-6">
            <ClientOnly>
                <SATProblem problem_id="ee017113-4883-4aa9-9fe4-91025944167d" />
            </ClientOnly>
        </div>
    </div>

    <h2 class="sat-guide-section-header">Different Subjects</h2>
    <div class="section-description">
        ...
        <div class="pt-6">
            <ClientOnly>
                <SATProblem problem_id="b773687e-291d-4477-9f33-5b0d31d760b2" />
            </ClientOnly>
        </div>
    </div>

    <h2 class="sat-guide-section-header">Punctuation</h2>
    <div class="section-description">
        ...
        <div class="pt-6">
            <ClientOnly>
                <SATProblem problem_id="1a66397d-449d-40c0-a694-0e3ecb0f460e" />
            </ClientOnly>
        </div>
    </div>

    <h2 class="sat-guide-section-header">Verb Form</h2>
    <div class="section-description">
        ...
        <div class="pt-6">
            <ClientOnly>
                <SATProblem problem_id="7452c1a1-41ad-4f94-904c-5e23390d8f53" />
            </ClientOnly>
        </div>
    </div>
    ...
    <div class='sat-guide-bottom-nav'>
        <div class='sat-guide-bottom-nav-item'>
            <UButton to='/sat/reading-writing/standard-english/question-types/pronouns' variant='outline' size='xl'>
                Next: Pronoun Questions
                <template #trailing>
