<template>
    ...
    <h2 class="sat-guide-section-header">Ways to Separate or Connect Complete Sentences</h2>
    <div class="section-description">
        There are several ways that you can properly separate or connect two complete sentences, summarized below:
        <ul>
            <li>
                ...
                <ul>
                    <li>
                        The most common and obvious way to separate two complete sentences is to use a period. For example, "The cat sleeps. The dog barks."
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li>
                        For the purposes of the SAT, semicolons can be used interchangeably with periods. Both can be used to separate complete sentences.
                    </li>
                    <li>
                        In reality, there is more nuance to deciding whether we would use a semicolon or a period. A semicolon suggests there is a stronger connection between the two sentences. However, the SAT doesn't test you on that level of nuance, so we won't focus on it. 
                    </li>
                    <li>
                        Semicolons also have a second use, which is to separate items in a list. We'll get into this more in the semicolons section.
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li>
                        We can also connect two independent clauses with a comma and a coordinating conjunction. We use the acronym FANBOYS to remember the coordinating conjunctions: for, and, nor, but, or, yet, so. For example, "The cat sleeps, and the dog barks." properly connects two independent clauses (aka complete sentences).
                    </li>
                    <li>
                        The comma should be placed before the conjunction. For example, "The cat sleeps and, the dog barks." would not work.
                    </li>
                    <li>
                        A comma on its own is not enough to connect two independent clauses. For example, "The cat sleeps, the dog barks." is not a proper sentence. This would be considered a comma splice, which is a grammatical error. We need the coordinating conjunction after the comma to connect the two clauses.
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li>
                        A colon can sometimes be used to connect two complete sentences, but it might also come between a complete sentence and a sentence fragment.
                    </li>
                    <li>
                        Whenever a colon is used correctly, there should always be a complete sentence before the colon.
                    </li>
                    <li>
