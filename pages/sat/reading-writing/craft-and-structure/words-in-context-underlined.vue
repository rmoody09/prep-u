<template>
    ...
    <div class="section-description">
        <div class="question-container">
            <ClientOnly>
                <SATProblem problem_id="cd8a0b34-24be-4fa6-b1ec-6f5bd3b80522" />
            </ClientOnly>
        </div>
    </div>
    ...
    <h2 class="sat-guide-section-header">The meaning of the underlined word is probably not its most typical meaning</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Trap 1: A synonym for the underlined word</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Trap 2: The opposite of the intended meaning</h2>
    <div class="section-description">
