<template>
    ...
    <h2 class="sat-guide-section-header">Wrong Answers To Look Out For</h2>
    <div class="section-description">
        Be on the lookout for all the common wrong answer types we discussed in <ULink class="text-primary" to='/sat/reading-writing/wrong-answers'>Wrong Answers</ULink>. One type of wrong answer to look out for in particular is an answer that is supported by the text, but doesn't relate to the underlined portion.
    </div>

    <div class='sat-guide-bottom-nav'>
        <div class='sat-guide-bottom-nav-item'>
            <UButton to='/sat/reading-writing/craft-and-structure/overall-structure' variant='outline' size='xl'>
