<template>
    ...
    <h2 class="sat-guide-section-header">How Is This Different From Main Idea Questions?</h2>
    <div class="section-description">
    ...
    <div class="section-description">
        You'll want to keep an eye out for all of the common wrong answer types we discussed in <ULink class="text-primary" to='/sat/reading-writing/wrong-answers'>Wrong Answers</ULink>, but once to particularly look out for on main purpose questions are:
        <div class="pt-4">
            <div>
                <strong>Supported by the text, but doesn't answer the question</strong>
            </div>
            <div>
