<template>
    ...
    <h2 class="sat-guide-section-header">The Actual Question Can Vary</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Summarize in Your Own Words</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Identify How the Texts Relate</h2>
    <div class="section-description">
    ...
    <div class="section-description">
        Be on the lookout for all the common wrong answer types we discussed in <ULink class="text-primary" to='/sat/reading-writing/wrong-answers'>Wrong Answers</ULink>, but especially the following:
        <div class="pt-4">
            <div>
                <strong>Overstatement</strong>
            </div>
            <div>
