<template>
    ...
    <div class="section-description">
        <div class="question-container">
            <ClientOnly>
                <SATProblem problem_id="56ef2d14-eae7-4421-beda-6a5f959b52cb" />
            </ClientOnly>
        </div>
    </div>

    <h2 class="sat-guide-section-header">Read the Passage Up to the Blank</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Read the Text After the Blank</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Identify the Relationship Between the Text Before and After the Blank</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Eliminate Answer Choices That Are Way Off</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Pick the Answer Choice That Most Precisely Matches the Relationship</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Know Your Transition Words and Phrases</h2>
    <div class="section-description">
