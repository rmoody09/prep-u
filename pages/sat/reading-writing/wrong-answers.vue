<template>
    <h1 class="sat-guide-page-header">Common Wrong Answers</h1>
    ...
    <h2 class="sat-guide-section-header">Trap #5: Supported by the text, but doesn't answer the question</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Trap #6: Opposite of the correct answer</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Trap #8: Overly literal interpretation of similes or metaphors</h2>
    <div class="section-description">
