<template>
    ...
    <h2 class="sat-guide-section-header">College Board Domains and Skills</h2>
    ...
    <h2 class="sat-guide-section-header">Reading & Writing Domains</h2>
    <div class="section-description">
        ...
        <div class="pt-4">
            <ul class="list-disc">
                <li>
                    <span class="font-semibold">Craft & Structure</span>
                    <ul>
                        <li>
                ...
                <li>
                    <span class="font-semibold">Information & Ideas</span>
                    <ul>
                        <li>
                ...
                <li>
                    <span class="font-semibold">Standard English Conventions</span>
                    <ul>
                        <li>
                ...
                <li>
                    <span class="font-semibold">Expression of Ideas</span>
                    <ul>
                        <li>
    ...
    <h2 class="sat-guide-section-header">Reading & Writing Skills</h2>
    <div class="section-description">
        ...
        <div>
            ...
            <ul class="list-disc">
                ...
                <li>
                    ...
                    <ul>
                        <li>Boundaries</li>
                        <li>Form, structure, and sense</li>
                    </ul>
                </li>
                <li>
                    <span class="font-semibold">Expression of Ideas</span>
    ...
    <h2 class="sat-guide-section-header">All The Question Types</h2>
    <div class="section-description">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>Main purpose</li>
                                <li>Function of underlined portion</li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            Command of evidence
                            <ul>
                                <li>Quantitative command of evidence</li>
                                <li>Illustrate claim</li>
                                <li>Strengthen/undermine claim</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li>Or as we call them, "Bullet point questions"</li>
                            </ul>
                        </li>
                        <li>Transitions</li>
                    </ul>
    ...
    <h2 class="sat-guide-section-header">Navigating Our Reading & Writing Guide</h2>
    <div class="section-description">
