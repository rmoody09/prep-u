<template>
    <h1 class="sat-guide-page-header">
        Strengthen/Undermine Questions
    </h1>

    <h2 class="sat-guide-section-header">How to Identify</h2>
    <div class="section-description">
        These questions will show up after the details and main idea questions. The wording can vary somewhat, but it will ask which of the answer choices, if true, would either strengthen or undermine a claim made in the text. Look out for the words "if true", and words like strengthen, support, weaken, undermine, etc.
    </div>
    ...
    <div class="section-description">
        <div class="question-container">
            <ClientOnly>
                <SATProblem problem_id="220a770e-68e2-4b00-ab41-2c266e0d4fc8" />
            </ClientOnly>
        </div>
    </div>
