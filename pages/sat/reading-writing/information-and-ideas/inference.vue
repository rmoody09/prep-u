<template>
    ...
    <div class="section-description">
        <div class="question-container">
            <ClientOnly>
                <SATProblem problem_id="7027747a-a1a3-4267-b54d-bb873faf1ae1" />
            </ClientOnly>
        </div>
    </div>
    ...
    <h2 class="sat-guide-section-header">Look For Transition Words and Phrases</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Try to Come Up With Your Own Answer First</h2>
    <div class="section-description">
