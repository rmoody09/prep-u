<template>
    ...
    <div class="section-description">
        <div class="question-container">
            <ClientOnly>
                <SATProblem problem_id="9aa26cc6-8624-4336-be8a-f62bb078e408" />
            </ClientOnly>
        </div>
    </div>
    ...
    <h2 class="sat-guide-section-header">Common Wrong Answer Types</h2>
    <div class="section-description">
        <div class="pt-4">
            <div>
                <strong>Accurate, but not the main idea</strong>
            </div>
            <div>
