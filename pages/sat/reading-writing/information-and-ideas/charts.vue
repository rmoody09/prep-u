<template>
    ...
    <div class="section-description">
        <div class="question-container">
            <ClientOnly>
                <SATProblem problem_id="51cf8d0d-de45-47fd-9713-dc8961f1896a" />
            </ClientOnly>
        </div>
    </div>

    <h2 class="sat-guide-section-header">Ignore the Graphic Initially</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Read the Question Carefully</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Identify the Hypothesis or Claim</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Read the Full Passage</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Read the Title of the Graphic</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Read the Axis Labels and Any Keys</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Look For Trends that Answer the Question</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Common Wrong Answers</h2>
    <div class="section-description">
