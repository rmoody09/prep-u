<template>
    ...
    <div class="section-description">
        <div class="question-container">
            <ClientOnly>
                <SATProblem problem_id="5c800d25-f5b9-447a-8ec3-6afe399c130f" />
            </ClientOnly>
        </div>
    </div>
    ...
    <h2 class="sat-guide-section-header">Read the Full Blurb</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Read Each Quote</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">The Claim Might Have Multiple Elements</h2>
    <div class="section-description">
    ...
    <h2 class="sat-guide-section-header">Be Prepared for Metaphorical, Abstract, or Antiquated Language</h2>
    <div class="section-description">
