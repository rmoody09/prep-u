...
export default eventHandler(async (event) => {
    ...
    const { problem_source, cb_subsource, collegeboard_question_id, practice_test, section, module, math_section, reading_writing_section, math_skill, reading_writing_skill, answer_type, numeric_answer, mult_choice_correct_answer_index, custom_skills, question, answer_choices } = body;
    ...
    */
    ...
    let input_answer = answer_type == 'numeric' ? numeric_answer : null;
