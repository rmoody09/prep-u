...
export const prepareSATDrillForDB = (drill) => {
    ...
    const sb_data = {
        sat_section: test_section, cb_domain, cb_skill, instructions_html, instructions_json, instructions_text, question_html, question_json, question_text, answer_type, numeric_answers: db_numeric_answers, numeric_answers_label, require_all_numeric_answers, text_answer_html, text_answer_json, text_answer_text, answer_is_exact, explanation_html, explanation_json, explanation_text, answer_choices, mult_choice_answer: mult_choice_correct_answer_index, custom_skills
    }
    return sb_data;
