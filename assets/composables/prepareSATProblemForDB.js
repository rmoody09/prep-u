...
export const prepareSATProblemForDB = (problem) => {
    const { problem_source, cb_subsource, collegeboard_question_id, practice_test, section, module, math_section, reading_writing_section, math_skill, reading_writing_skill, answer_type, input_answer, mult_choice_correct_answer_index, cb_difficulty, custom_skills, question, answer_choices } = problem;
