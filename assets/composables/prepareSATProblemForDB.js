...
export const prepareSATProblemForDB = (problem) => {
    const { problem_source, subsource, is_practice_test, in_cb_question_bank, collegeboard_question_id, practice_test, test_section, module, cb_domain, cb_skill, category, answer_type, input_answers, mult_choice_correct_answer_index, difficulty, custom_skills, concepts, question, answer_choices } = problem;
    console.log('prepareSATProblemForDB5');
